...
class Trainer
{
    ...
    {
        return "Trainer ID: {$this->id}, Name: {$this->name}, Email: {$this->email}, Location: {$this->location}, Certifications: {$this->certifications}, Years of Experience: {$this->years_experience}";
    }
}
